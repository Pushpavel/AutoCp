...
object AutoCpStrings {
    ...
    const val commandTemplateDesc = "" +
            "These commands are run in an isolated temporary directory. " +
            "@in in both these commands will be replaced with the absolute path to a solution file with quotes."
    ...
    const val inputMacroRequiredMsg = "" +
            "${R.keys.inputPathMacro} must appear at least once in either $buildCommandLabel or $executeCommandLabel."
